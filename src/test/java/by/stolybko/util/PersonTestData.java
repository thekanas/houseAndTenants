...
public class PersonTestData {
    ...
    public PersonEntity buildPersonEntity() {
        return new PersonEntity(id, personUuid, name, surname, sex, passport, house, createDate, updateDate, ownership);
    }
    ...
    public Page<PersonResponseDTO> buildPagePersonResponseDTO() {

        List<PersonResponseDTO> personResponseDTO = List.of(buildPersonResponseDTO(), buildPersonResponseDTO());
        return new PageImpl<>(personResponseDTO);
    }
}
